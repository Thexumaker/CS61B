...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        // Your code here!
        Queue<Queue<Item>> item = new Queue<Queue<Item>>();
        for (Item e : items) {
            Queue<Item> itemss = new Queue<>();
            itemss.enqueue(e);
            item.enqueue(itemss);
     ...
     *
     */
    //@Source staff solutions inspiration
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        Queue<Queue<Item>> queuesToMerge = makeSingleItemQueues(items);
        while (queuesToMerge.size() > 1){
            Queue<Item> q1 = queuesToMerge.dequeue();
            Queue<Item> q2 = queuesToMerge.dequeue();
            Queue<Item> merged = mergeSortedQueues(q1, q2);
            queuesToMerge.enqueue(merged);
        }
        return queuesToMerge.dequeue();
    }
